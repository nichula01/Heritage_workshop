...
def load_training():
    ...
    if not csv_files:
        raise FileNotFoundError(
            f"No training CSV files found under {TRAIN_ROOT}. Run extraction or check docs/dataset_setup.md."
        )
...
def load_descriptions():
    ...
    if not csv_files:
        raise FileNotFoundError(
            f"No description CSV files found under {DESC_ROOT}. Run extraction or check docs/dataset_setup.md."
        )
